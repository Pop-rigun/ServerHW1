...
- nodejs (native) http(s) server in folder [dedicatedServer](./dedicatedServer). 
Go to [dedicateServer README file](./dedicatedServer/README.md)
    
- nodejs express https server. To understand your task, please read the text below.


### Technical requirements

API client is required for this application.
...
_Note: If you select library with required auth, do not store your email and password in the code._ 
